...
MetaVM is written in Rust and organized as a Cargo workspace with five crates:
...
crates/
  ...
  riscv/   -- RV64IMA emulator (full Linux boot), trace generation, constraint system, CLI
...
MetaVM ships with a test suite spanning all five crates and is licensed under AGPL-3.0.
